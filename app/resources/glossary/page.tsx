...
export default function Page() {
  ...
  <PageBanner crumb="GLOSSARY" title={<>The industry's language, in plain English.</>} desc={<>If you're evaluating call and lead vendors, these are the terms that appear in every IO — and the ones vendors hope you won't ask about.</>} />

  <section className="section">
    <div className="container narrow prose">
      <h2 id="buffer">Buffer time</h2>
      <p>The number of connected seconds a call must last before it becomes billable. A 90-second buffer means calls that end at 89 seconds cost the buyer nothing. The buffer allocates risk between buyer and seller — longer buffers favor buyers. See how we use it in the pricing model.</p>
      ...
      <p>What a network pays a publisher per qualified call, accepted lead, or click. Payout terms include the rate, the qualification standard, and the payment schedule — all three matter. Ours are published on payouts &amp; terms.</p>
      ...
      <ReadyBand heading={"Fluent now? Put it to work."} />
    </>
  );
}
