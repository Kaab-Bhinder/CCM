...
const d: ServiceData = {
  ...
  features: [
    { icon: "brain", title: "Predictive Lead Scoring", desc: "Models trained on historical conversion data score every lead the moment it enters the network, so quality is assessed before it ever reaches a partner." },
    { icon: "handshake", title: "Automated Publisher Matching", desc: "Advertiser demand is matched to the right publishers automatically, based on vertical, geography, and past performance rather than manual guesswork." },
    { icon: "route", title: "Dynamic Call/Lead Routing", desc: "Routing decisions adjust in real time as capacity, quality, and buying windows shift, keeping every call and lead moving toward the best available outcome." },
    { icon: "trending", title: "Continuous Model Optimization", desc: "Every conversion feeds back into the system, so scoring and routing models keep improving without requiring a manual rebuild." },
  ],
