...
const d: ServiceData = {
  ...
  features: [
    { icon: "search", title: "Paid Search & Social", desc: "Campaigns built and managed across search and social platforms, targeting high-intent audiences in each vertical we serve." },
    { icon: "monitor", title: "Landing Page Optimization", desc: "Landing pages are designed and continuously tested to convert traffic into qualified calls and leads, not just clicks." },
    { icon: "palette", title: "Creative Testing", desc: "Ad creative, copy, and offers are tested in ongoing cycles, with underperformers replaced by what's actually converting." },
    { icon: "compass", title: "Multi-Channel Attribution", desc: "Every touchpoint is tracked across channels, giving a clear view of which sources are actually driving qualified volume." },
  ],
