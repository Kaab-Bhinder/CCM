...
const d: ServiceData = {
  ...
  features: [
    { icon: "phone", title: "Real-Time Call Routing", desc: "Calls are routed the moment they connect, matched against advertiser capacity, buying windows, and geography so every dial reaches a partner who can actually take it." },
    { icon: "target", title: "Call Verification & Scoring", desc: "Every call is scored on duration, intent signals, and source quality before it's billed, so advertisers only pay for conversations that meet their bar." },
    { icon: "shield", title: "Compliance-First Infrastructure", desc: "TCPA and DNC scrubbing run on every call before it's connected, with full consent tracking and call recording built into the pipeline from day one." },
    { icon: "dashboard", title: "Transparent Reporting", desc: "Live dashboards show call volume, source performance, and cost per qualified call, so there's never a question about where spend is going." },
  ],
